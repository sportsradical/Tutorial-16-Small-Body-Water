...
bool ApplicationClass::Initialize(HINSTANCE hinstance, HWND hwnd, int screenWidth, int screenHeight)
{
	...
	result = m_Terrain->Initialize(m_Direct3D->GetDevice(), m_Direct3D->GetDeviceContext(), "../Engine/data/textures/hm.bmp", "../Engine/data/textures/cm.bmp", 20.0f, "../Engine/data/textures/dirt.tga",
								   "../Engine/data/textures/normal.tga");
	if(!result)
	{
	...
	result = m_SkyPlane->Initialize(m_Direct3D->GetDevice(), m_Direct3D->GetDeviceContext(), "../Engine/data/textures/cloud001.tga", "../Engine/data/textures/perturb001.tga");
	if(!result)
	{
	...
	result = m_Water->Initialize(m_Direct3D->GetDevice(), m_Direct3D->GetDeviceContext(), "../Engine/data/textures/waternormal.tga", 3.75f, 110.0f);
	if(!result)
	{
